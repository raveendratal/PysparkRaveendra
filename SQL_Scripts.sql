...
insert into JOB_LIST_DYNAMIC values(7,'sales_transaction','localhost','sales_read','sales_read','sh','sh','sales_transaction','E:/files/SH/','username','password','sales_transaction','sales_transaction','csv','/mnt/landing/sales/','sales_transaction','sales_transaction','csv','stg_sales','sales','stg_sales_transaction','','curation_sales','sales','curation_sales_transaction','','dw_sales','sales','fact_sales_transaction','','/mnt/raw/sales/','sales_transaction','sales_transaction','csv','sales_schema','fact','incremental',1,current_timestamp(),current_timestamp(),'ETLJOB',current_timestamp(),'ETLJOB');
insert into JOB_LIST_DYNAMIC values(8,'costs_transaction','localhost','sales_read','sales_read','sh','sh','costs_transaction','E:/files/SH/','username','password','costs_transaction','costs_transaction','csv','/mnt/landing/sales/','costs_transaction','costs_transaction','csv','stg_sales','sales','stg_costs_transaction','','curation_sales','sales','curation_costs_transaction','','dw_sales','sales','fact_costs_transaction','','/mnt/raw/sales/','costs_transaction','costs_transaction','csv','costs_schema','fact','incremental',1,current_timestamp(),current_timestamp(),'ETLJOB',current_timestamp(),'ETLJOB');
